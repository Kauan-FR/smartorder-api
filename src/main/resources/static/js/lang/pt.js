...
I18n.register('pt', {
    ...
    // ==================== Store Nav Bar Js ====================
    storeNavbarJs: {
        failedCategories: 'Erro ao carregar categorias',
        confirmLogout: 'Tem certeza que deseja sair?',
        languageChanged: 'Idioma alterado para {0}',
        failedCart: 'Erro ao carregar o carrinho'
    },
    ...
    // ==================== Store Carousel Js ====================
    storeCarouselJs: {
        failedLoad: 'Erro ao carregar os produtos do carrossel'
    },

    // ==================== Store Cards ====================
    storeCard: {
        title: 'Todos os Produtos',
        end: 'Você viu todos os produtos',
    },
